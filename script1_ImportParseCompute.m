...
%% Prepare cell container for everything
...
N = nan(length(time.unix),nCol.res);

N(:,col.res.month_idx) = cell2mat(res(:,col.res.month_idx));
N(:,col.res.year) = cell2mat(res(:,col.res.year));
N(:,col.res.unix) = cell2mat(res(:,col.res.unix));
...
for mm = 1 : length(time.unix)
    ...
    N  (mm,col.res.prisma_e) = length(res{mm,col.res.prisma_e});
    T  (mm,col.res.prisma_e) = sum(t.e.num( res{mm,col.res.prisma_e} , col.e.duration ) );
    
    res{mm,col.res.verio_e } = find( current_month_idx_e & index.e.verio  );
    N  (mm,col.res.verio_e ) = length(res{mm,col.res.verio_e });
    T  (mm,col.res.verio_e ) = sum(t.e.num( res{mm,col.res.verio_e } , col.e.duration ) );
    ...
    N  (mm,col.res.prisma_auto) = length(res{mm,col.res.prisma_auto});
    T  (mm,col.res.prisma_auto) = sum(t.a.num( res{mm,col.res.prisma_auto} , col.a.duration ) );
    
    res{mm,col.res.prisma_m10 } = find( current_month_idx_a & index.a.prisma & index.a.m10  );
    N  (mm,col.res.prisma_m10) = length(res{mm,col.res.prisma_m10});
    T  (mm,col.res.prisma_m10) = sum(t.a.num( res{mm,col.res.prisma_m10} , col.a.duration ) );
    
    res{mm,col.res.prisma_p10 } = find( current_month_idx_a & index.a.prisma & index.a.p10  );
    N  (mm,col.res.prisma_p10) = length(res{mm,col.res.prisma_p10});
    T  (mm,col.res.prisma_p10) = sum(t.a.num( res{mm,col.res.prisma_p10} , col.a.duration ) );
    
    res{mm,col.res.verio_auto } = find( current_month_idx_a & index.a.verio  & index.a.auto );
    N  (mm,col.res.verio_auto) = length(res{mm,col.res.verio_auto});
    T  (mm,col.res.verio_auto) = sum(t.a.num( res{mm,col.res.verio_auto} , col.a.duration ) );
    
    res{mm,col.res.verio_m10  } = find( current_month_idx_a & index.a.verio  & index.a.m10  );
    N  (mm,col.res.verio_m10) = length(res{mm,col.res.verio_m10});
    T  (mm,col.res.verio_m10) = sum(t.a.num( res{mm,col.res.verio_m10} , col.a.duration ) );
    
    res{mm,col.res.verio_p10  } = find( current_month_idx_a & index.a.verio  & index.a.p10  );
    N  (mm,col.res.verio_p10) = length(res{mm,col.res.verio_p10});
    T  (mm,col.res.verio_p10) = sum(t.a.num( res{mm,col.res.verio_p10} , col.a.duration ) );
