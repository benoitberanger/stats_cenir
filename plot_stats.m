...
% 'Cr�neau confirm�'			'A';
% 'Coupure �lectrique'			'C';
% 'Maintenance mat�rielle'			'D';
% 'Intervention CENIR'			'F';
% 'Pr�sentation de projet IRM'			'H';
% 'R�union d''�quipe'			'P';
% 'Sp�cial'			'Q';
% 'Jour de cong�'			'Z';
% 'Congr�s et d�placement pro'			'Y';
% 'Maladie'			'X';
% 'Fermeture exceptionnelle'			'R';
% 'Formation'			'S';
% 'R�union'			'T';
% 'Pr�sentation de projet MEG'			'N';
% 'Pr�-r�servation'			'M';
% 'Cours'			'U';
% 'Cr�neau indisponible'			'E';
% 'Cr�neau disponible'			'I';
% 'Scan Paul Castaigne'			'G';
% 'Pr�sentation de projet EEG'			'O';
% 'Tiwi'			'J';
% 'Panne'			'AA';
% };
%
